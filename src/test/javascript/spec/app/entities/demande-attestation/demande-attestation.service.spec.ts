...
describe('Service Tests', () => {
    ...
    describe('DemandeAttestation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DemandeAttestationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/demande-attestations';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DemandeAttestation', () => {

                let entity: DemandeAttestation;
                service.find(123).subscribe((_entity: DemandeAttestation) => {
                    entity = _entity;
                });
